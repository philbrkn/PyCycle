...
if __name__ == "__main__":
    ...
    prob.set_val('DESIGN.fc.alt', 40000., units='ft')
    prob.set_val('DESIGN.fc.MN', 0.78)

    prob.set_val('DESIGN.fan.PR', 1.4)
    prob.set_val('DESIGN.lpc.PR', 2.5)
    prob.set_val('DESIGN.hpc.PR', 12)
    prob.set_val('DESIGN.splitter.BPR', 2)
    ...
    prob.set_val('DESIGN.T4_MAX', 1650, units='degK')
    prob.set_val('DESIGN.Fn_DES', 18000.0, units='lbf')
    ...
    viewer_file = open(f'PHIL_{date_time}.out', 'w')
