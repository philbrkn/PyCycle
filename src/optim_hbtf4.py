...
class HBTF(pyc.Cycle):
    ...
    def setup(self):
        ...
        if design:
            balance.add_balance("W", units="lbm/s", eq_units="lbf", lower=150, val=690)
...
class MPhbtf(pyc.MPCycle):
    ...
    def setup(self):
        ...
        self.pyc_add_pnt("OD_TOfail", HBTF(design=False, thermo_method="CEA", throttle_mode="percent_thrust"))
...
if __name__ == "__main__":
    ...
    # bal.add_balance('OD_TOC_Fn_target', val=7200, units='lbf', eq_units='lbf', use_mult=True, mult_val=1.2, ref0=5000.0, ref=7200.0)
    ...
    # bal.add_balance('OD_SLS_Fn_target', val=40000.0, units='lbf', eq_units='lbf', use_mult=True, mult_val=1.2)
