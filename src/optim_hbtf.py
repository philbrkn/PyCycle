...
class MPhbtf(pyc.MPCycle):
    ...
    def setup(self):
        ...
        self.pyc_add_pnt(
            "OD_TOfail", HBTF(design=False, thermo_method="CEA", throttle_mode="T4")
        )
...
if __name__ == "__main__":
    ...
    bal.add_balance('DESIGN_BPR', val=23.7281, units=None, eq_units=None)
    ...
    FAR_guess = [0.03081, 0.02541, 0.02510]
    W_guess = [1503.771, 1900., 802.79]
    BPR_guess = [5.431, 22.3467, 24.3233]
    lp_Nmech_guess = [5977.580, 6054.5, 6567.9]
    hp_Nmech_guess = [14217, 21594.0, 20574.1]
    hpt_PR_guess = [4.256, 4.245, 4.197]
    lpt_PR_guess = [5.051, 7.001, 10.803]
    fan_Rline_guess = [2.606, 1.7500, 1.9397]
    lpc_Rline_guess = [2.0052, 1.8632, 2.1075]
    hpc_Rline_guess = [2.116, 2.0281, 1.9746]
