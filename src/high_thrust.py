...
if __name__ == "__main__":
    ...
    bal.add_balance('OD_TOC_Fn_target', val=17000, units='lbf', eq_units='lbf', use_mult=True, mult_val=1.2, ref0=10000.0, ref=12000.0)
    ...
    bal.add_balance('OD_SLS_Fn_target', val=60000.0, units='lbf', eq_units='lbf', use_mult=True, mult_val=1.2553, ref0=50000.0, ref=55000.0)
    ...
    prob.set_val("fan:PRdes", 1.85)
    prob.set_val("lpc:PRdes", 1.18481111)
    prob.set_val('DESIGN.balance.rhs:hpc_PR', 35.67320561)
    prob.set_val('bal.rhs:DESIGN_BPR', 1.60125162)
    prob.set_val("DESIGN.splitter.BPR", 4)
