...
class HBTF(pyc.Cycle):
    ...
    def setup(self):
        ...
        main_order = ['fc', 'inlet', 'fan', 'splitter', 'duct4', 'lpc', 'duct6', 'hpc', 'bld3', 'burner', 'hpt', 'duct11',
                      'lpt', 'duct13', 'core_nozz', 'byp_bld', 'duct15', 'byp_nozz', 'lp_shaft', 'hp_shaft', 'perf', 'ext_ratio']
        ...
        if design:
            ...
            balance.add_balance('BPR', lower=2., upper=10.)
            self.connect('balance.BPR', 'splitter.BPR')
...
class MPhbtf(pyc.MPCycle):
    ...
    def setup(self):
        ...
        self.set_input_defaults('OD_TOfail.balance.rhs:FAR', 45000.0, units='lbf'),
        ...
        self.add_subsystem('T4_ratio',
                             om.ExecComp('DESIGN_T4 = OD_TOfail_T4*TR',
                                         OD_TOfail_T4={'val': 3400.0, 'units':'degR'},
                                         DESIGN_T4={'val': 3000.0, 'units':'degR'},
                                         TR={'val': 0.88235, 'units': None}), promotes_inputs=['OD_TOfail_T4',])
        self.connect('T4_ratio.DESIGN_T4', 'DESIGN.balance.rhs:FAR')

        initial_order = ['T4_ratio', 'DESIGN', 'OD_TOfail', 'OD_SLS', 'OD_TOC']
        # initial_order = ['DESIGN', 'OD_TOfail', 'OD_SLS', 'OD_TOC']
...
if __name__ == "__main__":
    ...
    bal.add_balance('DESIGN_W', val=650, units='lbm/s', eq_units='degR', rhs_name='OD_TOfail_T4')
    prob.model.connect('bal.DESIGN_W', 'DESIGN.fc.W')
    prob.model.connect('OD_TOfail.burner.Fl_O:tot:T', 'bal.lhs:DESIGN_W')
    ...
    # prob.model.add_design_var('OD_TOfail_T4', lower=3000.0, upper=3600.0, ref0=3000.0, ref=3600.0)
    ...
    prob.model.set_input_defaults('OD_TOfail_T4', 3400.0, units='degR')
    ...
    prob.set_val('T4_ratio.TR', 0.88235)
    prob.set_val('OD_TOfail_T4', 3400.0, units='degR')
    
    prob.set_val('OD_SLS.balance.rhs:FAR', 52000, units='lbf')
    prob.set_val('OD_TOC.balance.rhs:FAR', 12000, units='lbf')
