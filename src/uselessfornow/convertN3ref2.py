    ...
    def setup(self):
        ...
        if design:
            ...
            self.add_subsystem('opr_calc', om.ExecComp('OPR_simple = FPR*LPCPR*HPCPR',
                            ...
                            LPCPR={'val':1.50, 'units':None},
                            HPCPR={'val':16.0, 'units':None},
                            OPR_simple={'val':40.8, 'units':None}))
            ...
            balance.add_balance('BPR', lower=4., upper=40.)
...
class MPN3(pyc.MPCycle):
    ...
    def setup(self):
        ...
        self.set_input_defaults('CRZ.Fan_Nmech', 2184.5, units='rpm'),
        self.set_input_defaults('CRZ.LP_Nmech', 6772.0, units='rpm'),
        self.set_input_defaults('CRZ.HP_Nmech', 20871.0, units='rpm'),
        ...
        self.od_MNs = [0.25, 0.000001, 0.74]
        ...
        self.set_input_defaults('RTO.balance.rhs:FAR', 60000.0, units='lbf'),
...
if __name__ == "__main__":
    ...
    prob.set_val('CRZ.fc.W', 1600, units='lbm/s')
    prob.set_val('CRZ.splitter.BPR', 14.94514401),
    prob.set_val('CRZ.balance.rhs:hpc_PR', 40)
    ...
    prob.set_val('SLS.balance.rhs:FAR', 70000, units='lbf')
    prob.set_val('ToC.balance.rhs:FAR', 12000, units='lbf')
    prob.set_val('RTO.hpt_cooling.x_factor', 0.9)

    # Set initial guesses for balances
    prob['CRZ.balance.FAR'] = 0.02650
    prob['CRZ.balance.lpt_PR'] = 10.937
    prob['CRZ.balance.hpt_PR'] = 4.185
    prob['CRZ.fc.balance.Pt'] = 5.272
    prob['CRZ.fc.balance.Tt'] = 444.41

    FAR_guess = [0.02832, 0.02541, 0.02510]
    W_guess = [2516.13, 2500., 802.79]
